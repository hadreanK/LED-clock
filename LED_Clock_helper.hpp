...
#ifndef LED_Clock_Helper_hpp
#define LED_Clock_Helper_hpp

#define T3FREQ 100		// Frequency to switch between cathodes at (Hz), use timer 3
#define T4FREQ 1		// Timer 4 is for counting seconds
